...
(() => {
    // RUN LOADING SCREEN/SPLASH SCREEN/whatever you call it
    new Memuat(document.querySelector(".container")).init();
})();

// DETECTION WHETHER THE VISITOR HAS LOGGED IN OR NOT LOGGED IN
...
window.onresize = () => { // LISTENER WHEN THE SCREEN IS RESIZED
